...
const GROUPS = [
  ...
  ['Texture', [
    ['texMix',        'Splat blend',           0,   1,    0.05, 0.65],
    ['texNrmK',       'Detail-normal strength',0,   4,    0.1,  0.7],
    ['nrmLow',        'Low-octave normal',     0,   3,    0.1,  1.9],
    ['triSharp',      'Triplanar sharpness',   0,   10,   0.1,  1.0],
    ['texSat',        'Texture saturation',    0,   2,    0.05, 0.8],
    ['texBright',     'Texture brightness',    0.2, 1.5,  0.02, 0.64],
    ['biomeTint',     'Biome tint / texture',  0,   1,    0.02, 0.56],
    ['texWarp',       'Anti-repeat warp',      0,   0.6,  0.02, 0.32],
  ...
  ['Lighting / look', [
    ...
    ['variationAmt',  'Color variation',       0,   1,    0.01, 0.3],
    ['hazeMul',       'Aerial haze',           0,   2,    0.05, 0.15],
    ['diffWrap',      'Diffuse wrap',          0,   1,    0.05, 0.45],
    ['skyFill',       'Sky fill',              0,   1,    0.05, 0.5],
    ['vertexAO',      'Vertex AO',             0,   2,    0.05, 0.0],
    ['aoAmt',         'Slope AO',              0,   3,    0.1,  0.0],
    ['lookSat',       'Final saturation',      0,   2,    0.05, 0.7],
